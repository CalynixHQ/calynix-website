...
// Calynix wordmark — pure SVG paths, no external images.
// Triangle-A: left face blue, right face currentColor, bar light blue.
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      {/* A — triangle icon paths (from calynix-icon.svg, mapped to badge bbox x=129.48 y=33.37 w=118.09 h=119.51) */}
      <path d="M188.52,42.04 L148.88,133.74 L170.05,119.73 L188.52,76.98 Z" fill="#3B7BFF" />
      <path d="M188.52,42.04 L228.17,133.74 L207.00,119.73 L188.52,76.98 Z" fill="#EAF0FB" />
      <path d="M148.88,133.74 L228.17,133.74 L207.00,119.73 L170.05,119.73 Z" fill="#7FB0FF" />
      {/* L */}
      ...
      {/* I */}
      <path transform="translate(524.62,144.00) scale(0.144,-0.144)" d="M78 708H204V0H78Z" fill="currentColor" />
      {/* X */}
      <path transform="translate(565.35,144.00) scale(0.144,-0.144)" d="M249 378 29 708H181L327 466L471 708H616L400 375L654 0H495L322 278L156 0H4Z" fill="currentColor" />
    </svg>
  );
}
