...
// G · blue-A icon (transparent PNG) · M · E · S
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      {/* A — blue triangle icon paths (from calynix-icon.svg, mapped to badge bbox x=148.51 y=37.07 w=121.37 h=121.37) */}
      <path d="M209.19,45.88 L168.45,139.00 L190.20,124.78 L209.19,81.36 Z" fill="#3B7BFF" />
      <path d="M209.19,45.88 L249.94,139.00 L228.19,124.78 L209.19,81.36 Z" fill="#3B7BFF" />
