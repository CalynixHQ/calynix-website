...
export default function GamesWordmark({ className, title = "Calynix Games" }: GamesWordmarkProps) {
  return (
    ...
    >
      ...
      {/* A — from calynix-wordmark-light.svg geometry, shifted after G */}
      <path d="M180.65,36.04 L131.76,152.50 L157.34,135.50 L180.65,79.96 Z" fill="#2D6BFF" />
      <path d="M180.65,36.04 L229.54,152.50 L203.96,135.50 L180.65,79.96 Z" fill="#EAF0FB" />
      <path d="M131.76,152.50 L229.54,152.50 L203.96,135.50 L157.34,135.50 Z" fill="#5B95FF" />
      {/* M */}
