...
export default function Wordmark({ className, title = "Calynix" }: WordmarkProps) {
  return (
    ...
    >
      ...
      />
      {/* A — triangle */}
      <path d="M196.53,45.56 L159.25,130.77 L179.15,117.76 Z" fill="#3B7BFF" />
      <path d="M196.53,45.56 L233.81,130.77 L213.91,117.76 Z" fill="currentColor" />
      <path d="M159.25,130.77 L233.81,130.77 L213.91,117.76 L179.15,117.76 Z" fill="#7FB0FF" />
      {/* L */}
