...
export default function Wordmark({ className, title = "Calynix" }: WordmarkProps) {
  return (
    ...
    >
      ...
      {/* A — from calynix-wordmark-light.svg */}
      <path d="M176.00,36.04 L127.11,152.50 L152.69,135.50 L176.00,79.96 Z" fill="#2D6BFF" />
      <path d="M176.00,36.04 L224.89,152.50 L199.31,135.50 L176.00,79.96 Z" fill="#EAF0FB" />
      <path d="M127.11,152.50 L224.89,152.50 L199.31,135.50 L152.69,135.50 Z" fill="#5B95FF" />
      {/* L */}
